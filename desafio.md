...
1. Subir o projeto no [firebase hosting] (https://firebase.google.com/docs/hosting?hl=pt-br) e disponibilizar o link de acesso para a revisão.
2. Informar seu nome completo e link de acesso no formulário abaixo.
